...
def _get_message() -> str:
    return "Hi from forex_data_pipeline_new"

with DAG("forex_data_pipeline_new", start_date=datetime(2021, 1 ,1), 
    ...
    send_email_notification = EmailOperator(
        ...
        subject = "forex_data_pipeline_new",
        html_content = "<h3>forex_data_pipeline_new</h3>"
    )
